...
class SingleOperatorTest(unittest.TestCase):
    ...
    @staticmethod
    def test_conv_transpose():  # type: () -> None
        kernel_shape = (3, 3)
        pads = (0, 0, 0, 0)
        C_in = 3
        C_out = 12
    ...
    @staticmethod
    def test_conv_without_pads():  # type: () -> None
        kernel_shape = (3, 2)
        strides = (2, 3)
        dilations = (1, 2)
        group = 1
    ...
    @staticmethod
    def test_gemm(minimum_ios_deployment_target="12"):  # type: () -> None
        input_shape = (1, 2048)
        output_shape = (1, 5)
